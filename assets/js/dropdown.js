function flip() {
    if (flip == false) {
        $("#field-field-image").css({'transform': 'rotate(-180deg)'});
        flip = true;
    } else {
        $("#field-field-image").css({'transform': 'rotate(0deg)'});
        flip = false
    }}
...
var PittsburghTeams = [00,48,117,156,217,303,337,870,945,1308,1708,1743,1787,2051,2053,2252,2603,2641,2656,3061,3062,3171,3260,3492,3504,3511,3954,3955,3957,4027,4028,4049,4050,4145,4150,4269,4467,4521,4522,4547,4930,4991,5077,5472,5740,5811,5842,6032,6054,6414,6947,7165,7274];
